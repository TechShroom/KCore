...
/**
 * This class enhances functionality of java.util.jar.JarFile. Additional
 * functionality includes jar entry removal, the ability to list the entries
 * within a directory within the jar, and the ability to get an output stream
 * for modifying extisting entries.
 * 
...
public class EnhancedJarFile {
	...
	/**
	 * Returns a list of entries that are immediately below the entry named by
	 * entryName in the jar's directory structure.
	 * 
	 * @param entryName
	 *            the name of the directory entry name
	 * @return List a list of java.util.jar.JarEntry objects that are
	 *         immediately below the entry named by entryName in the jar's
	 *         directory structure.
	 */
	...
	/**
	 * Creates a new output entry stream within the jar. The entry named will be
	 * created if it does not exist within the jar already.
	 * 
	 * @param entryName
	 *            name of the entry for which to create an output stream.
	...
	/**
	 * Removes the given entry from the jar. If the entry does not exist, the
	 ...
	 * This method closes the old jar file, deletes it, moves the new jar file
	 * to the location where the old one used to be and opens it.
	 * 
	 * This is used when modifying the jar (removal, addition, or changes of
	 * entries)
	 * 
	 * @param newJarFile
